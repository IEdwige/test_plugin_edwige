...
from .zoom_dep_dialog import ZoomDepDialog
import os.path
...
class ZoomDep:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ZoomDep', message)
